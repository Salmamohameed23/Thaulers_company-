...
export default function PrivacyPolicy() {
    ...
    return (
      ...
      >
        ...
        {/* Content */}
        <section className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 py-7 lg:px-8">
          <p
            ...
            {t.privacy.sections.map((section, index) => (
              <div key={index} className={`flex gap-4 ${isAr ? "flex-row-reverse" : ""}`}>
                ...
                <div className={isAr ? "text-right w-full" : ""}>
                  ...
                  {section.items && (
                    <ul
                      className={`mt-3 list-disc space-y-1 text-[15px] leading-7 text-neutral-700 marker:text-red-600 ${
                        isAr ? "pr-5" : "pl-5"
                      }`}
                    >
