...
const ToolsHardwareProductDetails = () => {
  const { categorySlug, productSlug } = useParams();

  const product = toolsHardwareProducts.find(
  ...
  const customization = [
    "Private label and brand packaging available",
    "Material, finish, color and accessory options can be customized",
    "Export carton, barcode, manual and retail packaging support",
    ...
    <main className="bg-white text-zinc-950">
      ...
      <section className="bg-gray-50 px-6 py-14">
        <div className="mx-auto max-w-7xl">
          <Link
            to={`/solutions/tools-hardware/${product.categorySlug}`}
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
              ...
              <p className="text-sm font-semibold leading-7 text-gray-600">
                MOQ, voltage, plug type, accessories, material grade, finish,
                packaging style, logo method, barcode, manual, carton marks and
                export requirements can be adjusted according to the target
                market.
              </p>
            </div>
          </div>
...
export default ToolsHardwareProductDetails;
