      ...
      <section className="py-8 sm:py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="flex flex-col items-center justify-between gap-6 rounded-3xl bg-black px-8 py-9 text-white md:flex-row"
          >
            <div className={isAr ? "text-right" : ""}>
              <h2 className="text-2xl font-black">{t.solarAction.letsBuild.title}</h2>
              <p className="mt-2 font-medium text-white/65">{t.solarAction.letsBuild.desc}</p>
            </div>
            <Link
              to={ROUTES.letsBuild}
