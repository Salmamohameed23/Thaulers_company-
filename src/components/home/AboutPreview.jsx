...
const AboutPreview = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative mx-auto grid max-w-6xl items-stretch gap-16 px-6 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-10 ${
      ...
      >
        ...
        >
          ...
          <h2
            className={`text-[32px] font-black text-neutral-950 sm:text-[40px] lg:text-[44px] ${
              isAr
        ...
        <motion.div
          ...
          className={`relative flex h-full flex-col rounded-[28px] border border-black/5 bg-white p-6 shadow-[0_28px_70px_rgba(0,0,0,0.08)] sm:p-7 ${
            isAr ? "lg:[direction:rtl]" : ""
          }`}
        >
            ...
            {points.map((item) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group flex flex-1 items-center gap-4 rounded-[14px] border border-black/10 bg-white px-4 py-3 shadow-[0_12px_30px_rgba(0,0,0,0.045)] transition-all duration-300 hover:border-red-600/25 ${
